...
function finishQuiz() {
  ...
  if (playerData.goodAnswers >= 2) {
    beloning = "Jij verdient wel een beloning, helaas heb ik er geen voor je"
  }
  else {
    beloning = "Het wordt tijd dat je wat meer gaat leren"
  }
  resultBox.innerHTML = "<h2>Jouw resultaat: <br>goede antwoorden: " + playerData.goodAnswers + "<br>foute antwoorden: " + playerData.wrongAnswers + "<br>" + beloning + "</h2><button id=\"quizbutton\">Start quiz 2</button>";
